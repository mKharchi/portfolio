...
const MyApproach = () => {
  ...
  return (
    <div ref={containerRef} className="w-full my-40 sm:my-0  min-h-screen p-4 sm:px-20 sm:py-42 mx-auto flex flex-col gap-10 sm:gap-14 items-center justify-center">
      <h2 ref={titleRef} className="text-2xl sm:text-4xl font-bold">
        My <span className="text-[#CBACF9]">approach</span>
      </h2>
      <div className="w-full p-1  relative h-full grid grid-cols-1 md:grid-cols-2  gap-8 place-items-center  sm:gap-8">
        {steps.map(el => (
