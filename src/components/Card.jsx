...
const Card = ({ title, technologies, description, image, link, delay = 0 }) => {
  ...
  return (
    <motion.div
      ...
      className={`card shadow-[0px_4px_16px_rgba(54,126,8,0.3)] ${isExpanded ? "h-[450px]" : hasImage ? "h-[430px]" : "h-[260px]"} w-[360px] group gap-2 rounded-lg relative flex justify-end flex-col p-4 pt-6 z-50 overflow-hidden bg-gradient-to-b from-gray-800 to-gray-900 transition-all duration-300`}
    >
      {/* Background overlay */}
